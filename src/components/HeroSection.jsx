export default function HeroSection() {
  return (
    <div>
      ...
      <div className="w-full flex xl:hidden flex-col items-center gap-4 mb-6 lg:mt-0 justify-center z-0 max-h-48 md:max-h-96">
          <img
          ...
          alt="drawing"
          className="w-full object-cover team-card group max-h-48 md:max-h-96"
          />
      </div> 

      <div className="flex flex-col items-center gap-4 mt-6 md:mt-0 mb-8 md:pt-10">
        <div className='text-2xl container flex flex-row'>
          <div className='w-full xl:w-1/2 flex flex-col justify-center'>
            <div className='text-3xl sm:text-5xl md:text-6xl font-medium px-4'>
              <b>A centralized and automated solution for academic logistics</b>
            </div>
            <div className='text-md mt-2 font-serif md:pr-6 xl:pb-16 px-4'>
